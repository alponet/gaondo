...
class Version20171202000751 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user DROP username_canonical, DROP email_canonical, DROP confirmation_token, DROP enabled, DROP salt, DROP last_login, DROP password_requested_at, DROP roles)');
    }
}
